...
model = build_model()
model.summary()
mc_best = tf.keras.callbacks.ModelCheckpoint("Griewank_fkt_appro_UG_12Dto1D" + '/best_model', monitor='val_loss', mode='min',
...
model= tf.keras.models.load_model("Griewank_fkt_appro_UG_12Dto1D/best_model")
