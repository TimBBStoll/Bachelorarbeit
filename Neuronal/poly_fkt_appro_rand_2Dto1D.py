...
model = build_model()
model.summary()
mc_best = tf.keras.callbacks.ModelCheckpoint("poly_fkt_appro_rand_2Dto1D" + '/best_model', monitor='val_loss', mode='min',
...
model= tf.keras.models.load_model("poly_fkt_appro_rand_2Dto1D/best_model")
...
bvc=scatter_plot_2d(g1n,g2n,y1,lim_x=(0,1),lim_y=(0,1),log=False,color_map=0,label_x= "Random_2D", label_y="",title= "Polyfunktion 2D")
...
scatter_plot_2d(g1n,g2n,pointwise_err,lim_x=(0,1),lim_y=(0,1),log=True,color_map=0,label_x= "Random_2D", label_y="",title= "Polyfunktion 2D")