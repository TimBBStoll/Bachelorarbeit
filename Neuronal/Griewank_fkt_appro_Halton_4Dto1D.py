...
y=1+(1/4000)*a**2+(1/4000)*b**2+(1/4000)*c**2+(1/4000)*d**2-cos(a)*cos((1/2)*b*2**(1/2))*cos((1/3)*c*3**(1/2))*cos((1/4)*d*4**(1/2))
...
model = build_model()
model.summary()
mc_best = tf.keras.callbacks.ModelCheckpoint("Griewank_fkt_appro_Halton_4Dto1D" + '/best_model', monitor='val_loss', mode='min',
...
model= tf.keras.models.load_model("Griewank_fkt_appro_Halton_4Dto1D/best_model")
