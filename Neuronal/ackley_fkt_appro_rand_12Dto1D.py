...
y=(-20 * exp(-0.2 * sqrt(0.5 * (z**2)))-exp(0.5 * (cos(2 * pi * a)+cos(2 * pi * b)+cos(2 * pi * c)+cos(2 * pi * d)+cos(2 * pi * e)+cos(2 * pi * f)+cos(2 * pi * g)+cos(2 * pi *h)+cos(2 * pi * i)+cos(2 * pi * j)+cos(2 * pi * k)+cos(2 * pi * l))) + e + 20)
