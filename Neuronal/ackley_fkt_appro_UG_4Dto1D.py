...
model = build_model()
model.summary()
mc_best = tf.keras.callbacks.ModelCheckpoint("ackley_fkt_appro_UG_4Dto1D" + '/best_model', monitor='val_loss', mode='min',
...
model= tf.keras.models.load_model("ackley_fkt_appro_UG_4Dto1D/best_model")
