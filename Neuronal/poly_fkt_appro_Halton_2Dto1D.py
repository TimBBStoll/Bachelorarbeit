...
model = build_model()
model.summary()
mc_best = tf.keras.callbacks.ModelCheckpoint("poly_fkt_appro_Halton_2Dto1D" + '/best_model', monitor='val_loss', mode='min',
...
bvc=scatter_plot_2d(g1n,g2n,y1,lim_x=(0,1),lim_y=(0,1),log=False,color_map=0,label_x= "Halton_2D", label_y="",title= "Polyfunktion 2D")
...
scatter_plot_2d(g1n,g2n,pointwise_err,lim_x=(0,1),lim_y=(0,1),log=True,color_map=0,label_x= "Halton_2D", label_y="",title= "Polyfunktion 2D")